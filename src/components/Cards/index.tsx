...
export default function Cards() {
  return (
    <div className="flex flex-row items-center justify-around mt-32">
      ...
      <Card img={PaintBrush} alt='Message' title='Contact us' description="Do you want to rate us? Give us a suggestion? Are you getting troubles on the website? Don't worry; we are here." onClick={() => alert("Work in progress")} />
    </div>
  )
}