...
export default function NavBar() {
  ...
  return (
    <div className={isLight ? "bg-blue-500 h-sm w-full justify-between items-center flex fixed top-0 z-10 shadow-lg 2xl:h-[5rem]" : "dark:bg-zinc-800 h-sm justify-between items-center flex fixed w-full top-0 z-10 shadow-lg 2xl:h-[5rem]"}>
